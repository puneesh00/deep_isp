...
in_shape = (1984,1488,4)

base_vgg = VGG16(weights = 'imagenet', include_top = False, input_shape = (3968,2976,3))
...
for img in img_nos:
	...
	print(I.shape)
	I = np.reshape(I, [1, 1984, 1488, 4])
	out,_,_,_ = d_model.predict(I)
	out = np.reshape(out, [3968, 2976, 3])
